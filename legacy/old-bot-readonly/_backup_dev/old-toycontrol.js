...
async execute(interaction) {
	...
	//let msg = interaction.member.id;
		...
		if(interaction.client.qonSessions.find(obj => obj.users.includes(interaction.member.id)) ){
			...
			/*
			let msg2 = await interaction.editReply('You are already controlled in another session, do you want to leave your current session?');
